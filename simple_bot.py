...
Copy this template, replace YOUR info, and send:
...
✅ Just change YOUR_EMAIL and YOUR_PASSWORD
✅ Add your test emails in the "emails" part

Button links to: *https://{domain['url']}*"""
...
The code simplifies the input format for the fast test to be more user-friendly for non-technical users by providing a template with clear placeholders for email and password.
{
  "host": "smtp.gmail.com",
  "port": 587,
